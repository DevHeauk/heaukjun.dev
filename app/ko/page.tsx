...
export default function HomeKo() {
  ...
  return (
    <main lang="ko">
      <h1>유혁준</h1>
      <p>
        서울에서 일하는 풀스택 엔지니어입니다. 처음 4년은 네트워크 보안
        시스템을 C로 개발했습니다. 프록시, TLS 인터셉션, 트래픽 로깅 같은
        것들이었습니다. 이후 백엔드와 인프라를 맡았고, 최근에는 작은
        회사들에서 제품을 만들고 있습니다.
      </p>
      <p>
        요즘은 데이터 모델과 API부터 그것이 돌아가는 서버, 그 위의 클라이언트까지
        직접 개발합니다. 최근에는 무엇을 만들고 무엇을 측정할지, 언제 접을지를
        정하는 일까지 하게 됐습니다.
      </p>
      <p>
        생각을 정리하려고 글을 씁니다. 주로 무언가 망가졌던 이야기와, 지금이라면
        어떻게 했을지에 대해 씁니다.
      </p>
